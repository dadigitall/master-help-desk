...
class ProjectEdit extends Component
{
    ...
    protected $rules = [
        ...
        'prefix' => 'required|string|max:10|unique:projects,prefix,{project}',
    ...
    protected $listeners = [
        'openEditProjectModal' => 'openModal',
    ];
    ...
    public function generatePrefix()
    {
        ...
        // Check if prefix exists (excluding current project), if so, add number
        $originalPrefix = $prefix;
        $counter = 1;
        while (Project::where('prefix', $prefix)
    ...
    public function save()
    {
        ...
        try {
            ...
            $this->addError('update', 'Failed to update project. Please try again.');
        }
    }
